 ...
 */
package org.l2junity.scripts.instances.OctavisWarzone;
			...
			switch (event)
			{
				...
				case "START_STAGE_1":
				{
					...
					world.getAliveNpcs(BEASTS).forEach(beasts ->
					{
						...
						SuperpointManager.getInstance().startMoving(beasts, "octabis_superpoint");
					});
					break;
				}
				case "FOLLOW_BEASTS":
				...
				case "BEASTS_MINIONS_SPAWN":
				{
					...
					for (int i = 0; i < count; i++)
					{
						...
						addMoveToDesire(beast, BEASTS_RANDOM_POINT.getRandomPosition(500, 500), 23);
					}

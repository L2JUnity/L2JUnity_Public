 ...
 * @author Sdw
 */
public class PumpVitalityPointsRate extends AbstractDoubleStatEffect
{
	public PumpVitalityPointsRate(StatsSet params)
	{
		super(params, DoubleStat.VITALITY_POINTS_RATE);
	}

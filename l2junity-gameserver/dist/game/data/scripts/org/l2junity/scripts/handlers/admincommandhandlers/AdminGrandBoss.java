...
import org.l2junity.scripts.ai.individual.LairOfAntharas.Antharas.Antharas;
import org.l2junity.scripts.ai.individual.TowerOfInsolence.Baium.Baium;
...
public class AdminGrandBoss implements IAdminCommandHandler
{
	...
	{
		AdminCommandHandler.getInstance().registerHandler(new AdminGrandBoss());
	}
}
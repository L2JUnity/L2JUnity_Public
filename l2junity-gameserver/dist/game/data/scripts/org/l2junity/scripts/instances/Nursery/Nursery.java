 ...
 */
package org.l2junity.scripts.instances.Nursery;
			...
			if (getRandom(100) < 6)
			{
				switch (getRandom(3))
				{
					case 0:
						...
						break;
					case 1:
						addSkillCastDesire(npc, killer, ENERGY_SKILL_2, 1000000000);
						break;
					case 2:
						addSkillCastDesire(npc, killer, ENERGY_SKILL_3, 1000000000);
						break;
				}

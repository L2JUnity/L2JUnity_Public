 ...
 */
package org.l2junity.scripts.ai.individual.LairOfAntharas.Antharas;
...
import org.l2junity.gameserver.config.GrandBossConfig;
...
public final class Antharas extends AbstractNpcAI
{
	...
	public String onAttack(Npc npc, PlayerInstance attacker, int damage, boolean isSummon, Skill skill)
	{
		...
		if (npc.getId() == BOMBER)
		{
			if (npc.isInRadius3d(attacker, 230))
			{
				npc.doCast(DISPEL_BOM.getSkill());
				npc.doDie(attacker);
			}
		...
		else if (npc.getId() == ANTHARAS)
		{
			...
			{
				_logger.warn("Player " + attacker.getName() + " attacked Antharas in invalid conditions!");
	...
	private void manageSkills(Npc npc)
	{
		...
		if ((attacker_2 == null) || !npc.isInRadius3d(attacker_2, 9000) || attacker_2.isDead())
		{
			attacker_2_hate = 0;
		}
		
		if ((attacker_3 == null) || !npc.isInRadius3d(attacker_3, 9000) || attacker_3.isDead())
		{
			attacker_3_hate = 0;
		}
		...
		if (i2 > 0)
		{
			...
			final double distance_c2 = npc.distance3d(c2);

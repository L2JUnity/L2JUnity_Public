 ...
 */
package org.l2junity.scripts.vehicles;
...
{
	private static final Logger LOGGER = LoggerFactory.getLogger(BoatGludinRune.class);
		...
		try
		{
			switch (_cycle)
			{
				case 0:
					...
					ThreadPool.schedule(this, 240000, TimeUnit.MILLISECONDS);
					break;
				case 1:
					BoatManager.getInstance().broadcastPacket(GLUDIN_DOCK[0], RUNE_DOCK[0], LEAVE_GLUDIN1);
					ThreadPool.schedule(this, 40000, TimeUnit.MILLISECONDS);
					break;
				case 2:
				...
				case 3:
					...
					ThreadPool.schedule(this, 250000, TimeUnit.MILLISECONDS);
					break;
				case 4:
					BoatManager.getInstance().broadcastPacket(RUNE_DOCK[0], GLUDIN_DOCK[0], ARRIVAL_RUNE15);
					ThreadPool.schedule(this, 300000, TimeUnit.MILLISECONDS);
					break;
				case 5:
				...
				case 8:
					if (BoatManager.getInstance().dockBusy(BoatManager.RUNE_HARBOR))
					{
						...
						ThreadPool.schedule(this, 5000, TimeUnit.MILLISECONDS);
						return;
					}
				...
				case 13:
					...
					ThreadPool.schedule(this, 60000, TimeUnit.MILLISECONDS);
					break;
				case 14:

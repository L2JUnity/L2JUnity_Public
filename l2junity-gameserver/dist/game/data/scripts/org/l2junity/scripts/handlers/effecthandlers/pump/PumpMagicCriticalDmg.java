 ...
 * @author Sdw
 */
public class PumpMagicCriticalDmg extends AbstractDoubleStatEffect
{
	public PumpMagicCriticalDmg(StatsSet params)
	{
		super(params, DoubleStat.MAGIC_CRITICAL_DAMAGE, DoubleStat.MAGIC_CRITICAL_DAMAGE_ADD);
	}

 ...
 */
package org.l2junity.scripts.quests.Q10542_SearchingForNewPower;
...
public final class Q10542_SearchingForNewPower extends Quest
{
	...
	public Q10542_SearchingForNewPower()
	{
		...
		addCondCompletedQuest(Q10541_TrainLikeItsRealThing.class.getSimpleName(), "");
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		switch (event)
		{
			...
			case "32974-08.html":
			{
				if (qs.isCond(5))
				{
					giveItems(player, (player.isInCategory(CategoryType.MAGE_GROUP) ? SPIRITSHOTS : SOULSHOTS), 1000);
					addExp(player, 3200);
					addSp(player, 8);

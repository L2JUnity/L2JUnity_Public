...
/**
 * Restoration Enchant Random effect implementation.
 * @author
 */
public final class InstantRestorationEnchantRandom extends AbstractEffect
{
	final List<ExtractableProductItem> _products = new ArrayList<>();
	
	public InstantRestorationEnchantRandom(StatsSet params)
	{
	...
	{
		EffectHandler.getInstance().registerHandler("i_restoration_enchant_random", InstantRestorationEnchantRandom::new);
	}
}

 ...
 * @author Sdw
 */
public class PumpPhysicalAttackByHp1 extends AbstractDoubleStatConditionalHpEffect
{
	public PumpPhysicalAttackByHp1(StatsSet params)
	{
		super(params, DoubleStat.PHYSICAL_ATTACK, 30);
	}

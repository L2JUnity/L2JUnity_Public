 ...
 */
package org.l2junity.scripts.quests.Q00185_NikolasCooperation;
...
public final class Q00185_NikolasCooperation extends Quest
{
			...
			case "30673-09.html":
			{
				if (qs.isMemoState(6))
				{
					...
					if (player.getLevel() < MAX_LEVEL_FOR_EXP_SP)
					{
						...
						addExp(player, 203717);
						addSp(player, 14032); // TODO Incorrect SP reward.
					}
					else
					{
						giveAdena(player, 72527, true);
	...
	public String onTalk(Npc npc, PlayerInstance player)
	{
		...
		if (qs.isCreated())
		{
			...
			{
				if (player.hasQuestCompleted(Q00183_RelicExploration.class.getSimpleName()) && //
					player.hasQuestState(Q00184_ArtOfPersuasion.class.getSimpleName()) && //
					player.hasQuestState(Q00185_NikolasCooperation.class.getSimpleName()))
				{

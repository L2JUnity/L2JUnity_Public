 ...
 */
package org.l2junity.scripts.village_master.ClanPleaseReworkMeIWantToDie;
 ...
 * @author UnAfraid
 */
public final class ClanPleaseReworkMeIWantToDie extends AbstractNpcAI
{
	// @formatter:off
	...
	private ClanPleaseReworkMeIWantToDie()
	{
		addStartNpc(NPCS);
		addTalkId(NPCS);
	}
	...
	{
		new ClanPleaseReworkMeIWantToDie();
	}
}

 ...
 * @author Sdw
 */
public class PumpPvpPhysicalAttackDefenceBonus extends AbstractDoubleStatEffect
{
	public PumpPvpPhysicalAttackDefenceBonus(StatsSet params)
	{
		super(params, DoubleStat.PVP_PHYSICAL_ATTACK_DEFENCE);
	}

 ...
 * @author St3eT
 */
public final class CrystalCavernsEmeraldSquare extends AbstractInstance
{
	// NPCs
		...
		if (isInInstance(instance))
		{
			...
			switch (event)
			{
				case "HP_REGEN_TIMER":
				{
					...
					npc.getStat().addFixedValue(DoubleStat.REGENERATE_HP_RATE, Double.valueOf(value * 1000));
					break;
				}
				...
				case "CANNON_LOOP_ATTACK":
				{
					if (npc.getCurrentHpPercent() > 30)
					{
						...
						{
							final Npc cannonSkill = addSpawn(WATER_CANNON_SKILL, npc.getRandomPosition(50, 400), false, 0, false, instance.getId());

 ...
 * @author Sdw
 */
public class PumpCriticalRateByHp1 extends AbstractDoubleStatConditionalHpEffect
{
	
	public PumpCriticalRateByHp1(StatsSet params)
	{
		super(params, DoubleStat.CRITICAL_RATE, 30);
	}

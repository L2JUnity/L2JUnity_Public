...
public final class ChatWhisper implements IChatHandler
{
	...
	public void handleChat(ChatType type, PlayerInstance activeChar, String target, String text)
	{
		...
		if ((receiver != null) && !receiver.isSilenceMode(activeChar.getObjectId()))
		{
			...
			{
				activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.PLAYERS_CAN_RESPOND_TO_A_WHISPER_BUT_CANNOT_INITIATE_A_WHISPER_UNTIL_AFTER_LV_S1).addInt(GeneralConfig.MINIMUM_CHAT_LEVEL));
				return;
			}

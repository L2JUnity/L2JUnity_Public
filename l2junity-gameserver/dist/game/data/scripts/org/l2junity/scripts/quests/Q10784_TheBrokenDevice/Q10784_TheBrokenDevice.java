 ...
 */
package org.l2junity.scripts.quests.Q10784_TheBrokenDevice;
...
public final class Q10784_TheBrokenDevice extends Quest
{
	...
	private static final int SPIRITSHOT_A = 3951;
	private static final int PAULINA_EQUIPMENT_SET_A = 46851;
			...
			case "33866-08.html":
			{
				if (qs.isCond(2))
				{
					if ((player.getLevel() >= MIN_LEVEL))
					{
						...
						giveItems(player, SPIRITSHOT_A, 6000);
						giveItems(player, BLESSED_SCROLL_OF_ESCAPE, 3);
						giveItems(player, PAULINA_EQUIPMENT_SET_A, 1);

 ...
 */
package org.l2junity.scripts.quests.Q10385_RedThreadOfFate;
...
import org.l2junity.scripts.instances.TalkingIslandPast.TalkingIslandPast;
...
public final class Q10385_RedThreadOfFate extends Quest
{
	...
	public void onPlayerSocialAction(OnPlayerSocialAction event)
	{
		...
		if ((target != null) && target.isNpc() && (target.getId() == LANYA))
		{
			...
			if (((qs != null) && (qs.isCond(3))) && (event.getSocialActionId() == SOCIAL_BOW) && (player.isInRadius3d(npc, 120)))
			{
				qs.setCond(4, true);
			}
		}

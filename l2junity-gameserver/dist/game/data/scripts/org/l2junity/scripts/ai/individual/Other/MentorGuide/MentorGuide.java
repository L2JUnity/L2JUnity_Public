 ...
 */
package org.l2junity.scripts.ai.individual.Other.MentorGuide;
...
public final class MentorGuide extends AbstractNpcAI implements IGameXmlReader
{
	...
	{
		new SkillHolder(9227, 1), // Mentor's Horn Melody
		new SkillHolder(9228, 1), // Mentor's Drum Melody
		new SkillHolder(9229, 1), // Mentor's Lute Melody
		new SkillHolder(9230, 1), // Mentor's Pipe Organ Melody
		new SkillHolder(9231, 1), // Mentor's Guitar Melody
		new SkillHolder(9232, 1), // Mentor's Harp Melody
	...
	private static final SkillHolder MENTOR_ART_OF_SEDUCATION = new SkillHolder(18594, 1); // Mentor's Art of Seduction
	// Misc
	...
	public void load()
	{
		...
		LOGGER.info("Loaded: {} mentee coins", MENTEE_COINS.size());
	}
	...
	public void onMenteeLeft(OnPlayerMenteeLeft event)
	{
		...
		{
			mentor.removeSkill(MENTOR_ART_OF_SEDUCATION.getSkill(), true);
	...
	private void handleMentorSkills(PlayerInstance player)
	{
		...
		if (player.getKnownSkill(MENTOR_ART_OF_SEDUCATION.getSkillId()) == null)
		{
			...
			player.addSkill(MENTOR_ART_OF_SEDUCATION.getSkill(), false);
		}
	}

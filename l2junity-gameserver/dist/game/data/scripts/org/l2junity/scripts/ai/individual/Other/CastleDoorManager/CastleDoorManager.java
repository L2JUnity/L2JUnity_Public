 ...
 */
package org.l2junity.scripts.ai.individual.Other.CastleDoorManager;
...
public final class CastleDoorManager extends AbstractNpcAI
{
	...
	{
		return ArrayUtil.contains(DOORMENS_INNER, npc.getId()) ? "CastleDoorManager-Inner" : "CastleDoorManager-Outter";
	}

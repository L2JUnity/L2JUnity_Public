 ...
 */
package org.l2junity.scripts.custom.events.Rabbits;
...
public final class Rabbits extends Event
{
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		switch (event)
		{
			...
			case "transform":
			{
				...
				npc.doInstantCast(player, RABBIT_TRANSFORMATION);
				_players.add(player);
				break;
			}
	...
	public String onSkillSee(Npc npc, PlayerInstance caster, Skill skill, WorldObject[] targets, boolean isSummon)
	{
		...
		{
			if (npc.isInvisible() && npc.isInRadius2d(caster, skill.getAffectRange()))
			{
	...
	public String onAttack(Npc npc, PlayerInstance attacker, int damage, boolean isSummon, Skill skill)
	{
		...
		{
			npc.doInstantCast(attacker, RAID_CURSE);
		}

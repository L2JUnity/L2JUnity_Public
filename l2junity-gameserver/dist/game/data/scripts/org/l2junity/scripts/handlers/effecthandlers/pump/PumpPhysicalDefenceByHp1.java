 ...
 * @author Sdw
 */
public class PumpPhysicalDefenceByHp1 extends AbstractDoubleStatConditionalHpEffect
{
	public PumpPhysicalDefenceByHp1(StatsSet params)
	{
		super(params, DoubleStat.PHYSICAL_DEFENCE, 30);
	}

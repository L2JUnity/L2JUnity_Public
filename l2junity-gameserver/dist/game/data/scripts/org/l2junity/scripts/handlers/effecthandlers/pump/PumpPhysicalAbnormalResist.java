 ...
 * @author Sdw
 */
public class PumpPhysicalAbnormalResist extends AbstractDoubleStatAddEffect
{
	public PumpPhysicalAbnormalResist(StatsSet params)
	{
		super(params, DoubleStat.ABNORMAL_RESIST_PHYSICAL);
	}

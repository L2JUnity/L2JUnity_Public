 ...
 */
package org.l2junity.scripts.quests.Q00648_AnIceMerchantsDream;
...
public final class Q00648_AnIceMerchantsDream extends Quest
{
	...
	public String onKill(Npc npc, PlayerInstance killer, boolean isSummon)
	{
		...
		if (st != null)
		{
			...
			{
				if ((st.getCond() >= 2) && st.getPlayer().hasQuestCompleted(Q00115_TheOtherSideOfTruth.class.getSimpleName()))
				{

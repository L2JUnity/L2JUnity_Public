 ...
 * @author Sdw
 */
public class PumpCriticalDamage extends AbstractDoubleStatEffect
{
	public PumpCriticalDamage(StatsSet params)
	{
		super(params, DoubleStat.CRITICAL_DAMAGE, DoubleStat.CRITICAL_DAMAGE_ADD);
	}

 ...
 */
package org.l2junity.scripts.quests.Q10359_TracesOfEvil;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30289-08.html" : "30289-02.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30289-06.html" : "30289-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30288-02.html" : "30288-08.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30288-06.html" : "30288-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30297-01.html" : "30297-02.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30297-06.html" : "30297-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30505-02.html" : "30505-03.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30505-06.html" : "30505-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30504-02.html" : "30504-03.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30504-06.html" : "30504-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "32196-02.html" : "32196-03.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "32196-06.html" : "32196-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30158-02.html" : "30158-03.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30158-08.html" : "30158-07.html";
									break;
							}
						}
						break;
						...
						if ((st.getCond() >= 4) && (st.getCond() <= 11))
						{
							switch (player.getRace())
							{
								case DARK_ELF:
									...
									break;
								case HUMAN:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30155-02.html" : "30155-03.html";
									break;
								case ORC:
								...
								case KAMAEL:
									...
									break;
								case ELF:
									htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "30155-07.html" : "30155-08.html";
									break;
							}
						}
						break;

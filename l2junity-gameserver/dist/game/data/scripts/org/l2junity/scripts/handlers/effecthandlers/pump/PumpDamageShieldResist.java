 ...
 * @author Sdw
 */
public class PumpDamageShieldResist extends AbstractDoubleStatAddEffect
{
	public PumpDamageShieldResist(StatsSet params)
	{
		super(params, DoubleStat.REFLECT_DAMAGE_PERCENT_DEFENSE);
	}

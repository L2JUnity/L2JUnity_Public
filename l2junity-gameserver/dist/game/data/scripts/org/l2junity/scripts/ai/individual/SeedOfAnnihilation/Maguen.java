 ...
 */
package org.l2junity.scripts.ai.individual.SeedOfAnnihilation;
...
import org.l2junity.scripts.ai.individual.SeedOfAnnihilation.Nemo.Nemo;
...
public final class Maguen extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		switch (event)
		{
			...
			{
				if ((npc.distance3d(player) < 100) && (npc.getVariables().getInt("IS_NEAR_PLAYER") == 0))
				{
	...
	public String onKill(Npc npc, PlayerInstance killer, boolean isSummon)
	{
		if (killer.isInParty())
		{
			...
			if ((getRandom(1000) < i0) && (npc.distance3d(killer) < 2000) && (npc.distance3d(partyMember) < 2000))
			{

 ...
 * @author Sdw
 */
public class PumpPvpPhysicalSkillDefenceBonus extends AbstractDoubleStatEffect
{
	public PumpPvpPhysicalSkillDefenceBonus(StatsSet params)
	{
		super(params, DoubleStat.PVP_PHYSICAL_SKILL_DEFENCE);
	}

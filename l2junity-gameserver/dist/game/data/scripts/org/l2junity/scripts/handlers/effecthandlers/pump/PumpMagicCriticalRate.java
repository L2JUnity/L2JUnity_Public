 ...
 * @author Sdw
 */
public class PumpMagicCriticalRate extends AbstractDoubleStatEffect
{
	public PumpMagicCriticalRate(StatsSet params)
	{
		super(params, DoubleStat.MAGIC_CRITICAL_RATE);
	}

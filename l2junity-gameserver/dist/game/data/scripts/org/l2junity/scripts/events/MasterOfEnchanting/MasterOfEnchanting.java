 ...
 */
package org.l2junity.scripts.events.MasterOfEnchanting;
...
public final class MasterOfEnchanting extends LongTimeEvent
{
	...
	private static final String RESET_VAR = "EnchantEvent";
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		else if (event.equalsIgnoreCase("buy_scroll_24"))
		{
			...
			long reuse = vars.getLong(RESET_VAR, 0);
			...
			if (curTime > reuse)
			{
				if (getQuestItemsCount(player, Inventory.ADENA_ID) > SCROLL_24_PRICE)
				{
					...
					vars.set(RESET_VAR, System.currentTimeMillis() + (SCROLL_24_TIME * 3600000));

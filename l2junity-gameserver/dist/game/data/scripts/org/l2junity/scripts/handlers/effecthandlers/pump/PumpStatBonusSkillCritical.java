 ...
 * @author Sdw
 */
public class PumpStatBonusSkillCritical extends AbstractEffect
{
	private final BaseStats _stat;
	protected final int _armorTypesMask;
	
	public PumpStatBonusSkillCritical(StatsSet params)
	{
	...
	{
		target.getStat().mergeAdd(DoubleStat.STAT_BONUS_SKILL_CRITICAL, _stat.ordinal() + 1);
	}

 ...
 * @author Sdw
 */
public class PumpPvpPhysicalAttackDmgBonus extends AbstractDoubleStatEffect
{
	public PumpPvpPhysicalAttackDmgBonus(StatsSet params)
	{
		super(params, DoubleStat.PVP_PHYSICAL_ATTACK_DAMAGE);
	}

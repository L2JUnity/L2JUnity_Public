 ...
 * @author Sdw
 */
public class PumpDefenceCriticalRate extends AbstractDoubleStatEffect
{
	public PumpDefenceCriticalRate(StatsSet params)
	{
		super(params, DoubleStat.DEFENCE_CRITICAL_RATE, DoubleStat.DEFENCE_CRITICAL_RATE_ADD);
	}

...
public class AdminInvul implements IAdminCommandHandler
{
	...
	private void handleUndying(Creature activeChar)
	{
		...
		if (activeChar.isUndying())
		{
			...
			if (GeneralConfig.DEBUG)
			{
				LOGGER.debug("GM: Gm removed undying mode from character " + activeChar.getName() + "(" + activeChar.getObjectId() + ")");
			}
		}
		else
		{
			...
			if (GeneralConfig.DEBUG)
			{
				LOGGER.debug("GM: Gm activated undying mode for character " + activeChar.getName() + "(" + activeChar.getObjectId() + ")");
			}
		}
		activeChar.sendMessage(text);
	}

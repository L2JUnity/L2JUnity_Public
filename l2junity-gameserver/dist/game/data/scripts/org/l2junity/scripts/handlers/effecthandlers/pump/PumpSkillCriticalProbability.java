 ...
 * @author Sdw
 */
public class PumpSkillCriticalProbability extends AbstractDoubleStatEffect
{
	public PumpSkillCriticalProbability(StatsSet params)
	{
		super(params, DoubleStat.SKILL_CRITICAL_PROBABILITY);
	}

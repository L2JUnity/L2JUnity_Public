 ...
 * @author Sdw
 */
public class PumpAvoidRateByHp2 extends AbstractDoubleStatConditionalHpEffect
{
	public PumpAvoidRateByHp2(StatsSet params)
	{
		super(params, DoubleStat.EVASION_RATE, 60);
	}

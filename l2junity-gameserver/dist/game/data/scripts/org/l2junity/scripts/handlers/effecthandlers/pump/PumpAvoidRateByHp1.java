 ...
 * @author Sdw
 */
public class PumpAvoidRateByHp1 extends AbstractDoubleStatConditionalHpEffect
{
	public PumpAvoidRateByHp1(StatsSet params)
	{
		super(params, DoubleStat.EVASION_RATE, 30);
	}

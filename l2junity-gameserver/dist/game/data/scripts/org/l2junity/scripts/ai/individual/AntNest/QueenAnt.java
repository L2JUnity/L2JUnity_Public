 ...
 */
package org.l2junity.scripts.ai.individual.AntNest;
...
public final class QueenAnt extends AbstractNpcAI
{
	...
	public String onAggroRangeEnter(Npc npc, PlayerInstance player, boolean isSummon)
	{
		...
		{
			isMage = player.isInCategory(CategoryType.MAGE_GROUP);
			character = player;
		}
		...
		if (!NpcConfig.RAID_DISABLE_CURSE && ((character.getLevel() - npc.getLevel()) > 8))
		{
			...
			if (curse != null)
			{
				...
				npc.doInstantCast(character, curse);
			}
	...
	public String onKill(Npc npc, PlayerInstance killer, boolean isSummon)
	{
		...
		if (npcId == QUEEN)
		{
			...
			long respawnTime = GrandBossConfig.QUEEN_ANT_SPAWN_INTERVAL + (getRandom(-GrandBossConfig.QUEEN_ANT_SPAWN_RANDOM, GrandBossConfig.QUEEN_ANT_SPAWN_RANDOM) * 3600000);

...
public final class PumpTriggerSkillByDmg extends AbstractEffect
{
	...
	{
		if ((event.getAttacker() == null) || event.isDamageOverTime() || (_chance == 0) || (_skill.getSkillLevel() == 0))
		{
			return;
		}
		...
		// Temp fix for stack overflow caused by this trigger to hit enemy, get reflected, hit enemy, get reflected... Example skill is Squall/Sayha's Fury.
		if (triggerSkill.equals(event.getSkill()))
		{
			return;
		}

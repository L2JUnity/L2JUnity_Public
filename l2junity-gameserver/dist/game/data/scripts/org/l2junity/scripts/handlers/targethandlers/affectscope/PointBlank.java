 ...
 */
package org.l2junity.scripts.handlers.targethandlers.affectscope;
...
import org.l2junity.scripts.handlers.targethandlers.affectobject.ObjectDeadNpcBody;
			...
			if (activeChar.isPlayable())
			{
				...
				if (worldPosition != null)
				{
					World.getInstance().forEachVisibleObjectInRadius(activeChar, Creature.class, (int) (affectRange + activeChar.distance2d(worldPosition)), c ->
					{
						...
						if (c.isDead() && !(skill.getAffectObjectHandler() instanceof ObjectDeadNpcBody))
						{
							return;
						}

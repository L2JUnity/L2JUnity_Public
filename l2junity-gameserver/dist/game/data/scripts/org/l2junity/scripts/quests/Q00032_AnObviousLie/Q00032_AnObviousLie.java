 ...
 */
package org.l2junity.scripts.quests.Q00032_AnObviousLie;
...
public final class Q00032_AnObviousLie extends Quest
{
	...
	private static final ItemHolder ARMOR_FRAGMENT_LOW_GRADE = new ItemHolder(36551, 70);
	private static final ItemHolder ACCESORY_GEM_LOW_GRADE = new ItemHolder(36556, 145);
	// Misc
	...
	public Q00032_AnObviousLie()
	{
		...
		addKillId(ALLIGATOR);
		addCondMinLevel(MIN_LVL, "30120-03.htm");
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		switch (event)
		{
			...
			case "rabbit":
			{
				if (qs.isCond(8) && takeAllItems(player, ARMOR_FRAGMENT_LOW_GRADE, ACCESORY_GEM_LOW_GRADE))
				{
				...
				switch (npc.getId())
				{
					...
					case GENTLER:
					{
						switch (qs.getCond())
						{
							...
							case 8:
							{
								if (hasAllItems(player, true, ARMOR_FRAGMENT_LOW_GRADE, ACCESORY_GEM_LOW_GRADE))
								{

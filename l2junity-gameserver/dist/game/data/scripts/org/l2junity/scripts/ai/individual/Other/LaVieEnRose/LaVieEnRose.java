 ...
 */
package org.l2junity.scripts.ai.individual.Other.LaVieEnRose;
	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player)
	{
		...
		switch (event)
		{
			...
			case "restore_appearance":
			{
				...
				{
					if (player.getVariables().hasVariable(PlayerVariables.VISUAL_HAIR_ID) || player.getVariables().hasVariable(PlayerVariables.VISUAL_FACE_ID) || player.getVariables().hasVariable(PlayerVariables.VISUAL_HAIR_COLOR_ID))
					{

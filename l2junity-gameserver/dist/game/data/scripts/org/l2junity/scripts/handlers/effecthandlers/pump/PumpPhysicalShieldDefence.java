 ...
 * @author Sdw
 */
public class PumpPhysicalShieldDefence extends AbstractDoubleStatEffect
{
	public PumpPhysicalShieldDefence(StatsSet params)
	{
		super(params, DoubleStat.SHIELD_DEFENCE);
	}

 ...
 */
package org.l2junity.scripts.quests.Q10360_CertificationOfFate;
...
public final class Q10360_CertificationOfFate extends Quest
{
	...
	private static final int SPIRITSHOT_C = 3949;
	private static final int PAULINA_EQUIPMENT_SET_C = 46850;
	// Locations
			...
			case "33518-06.htm":
			{
				switch (player.getRace())
				{
					...
					case ELF:
						...
						htmltext = player.isInCategory(CategoryType.MAGE_GROUP) ? "33518-12.htm" : "33518-13.htm";
						break;
				}
				playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
				break;
			...
			default:
			{
				...
				else if (event.startsWith("classChange;"))
				{
					...
					else if ((player.getLevel() >= MIN_LEVEL))
					{
						...
						giveAdena(player, 461_880, true);
						giveItems(player, MAJOR_HEALING_POTION, 50);
						giveItems(player, SOULSHOT_C, 3000);
						giveItems(player, SPIRITSHOT_C, 3000);
						giveItems(player, PAULINA_EQUIPMENT_SET_C, 1);
